...
require (
	...
	gitlab.cept.gov.in/it-2.0-common/n-api-db v0.0.4
	gitlab.cept.gov.in/it-2.0-common/n-api-errors v0.0.4
	gitlab.cept.gov.in/it-2.0-common/n-api-log v0.0.1
	gitlab.cept.gov.in/it-2.0-common/n-api-server v0.0.17
	gitlab.cept.gov.in/it-2.0-common/n-api-validation v0.0.4
